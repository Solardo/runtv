...
function FastClick(layer, options) {
  ...
  var context = this;
  for (var i = 0, l = methods.length; i < l; i++) {if (window.CP.shouldStopExecution(0)) break;
    context[methods[i]] = bind(context[methods[i]], context);
  }

  // Set up event handlers as required
  window.CP.exitedLoop(0);if (deviceIsAndroid) {
...
FastClick.prototype.updateScrollParent = function (targetElement) {
  ...
  if (!scrollParent || !scrollParent.contains(targetElement)) {
    ...
    } while (parentElement);window.CP.exitedLoop(1);
  }
...
var WallPaper = {
  ...
  setPopHtml: function (index, popImg, pcImg, mobileImg) {
    var html = [
    '<div class="wp-pop-wrap" data-index="' + index + '">',
    '<div class="wp-pop">',
    '<div class="wp-pop-img">',
    '<img id="J_pop_img" src="' + popImg + '">',
    '<a href="javascript:;" class="wp-pop-icon wp-pop-arrow-left"></a>',
    '<a href="javascript:;" class="wp-pop-icon wp-pop-arrow-right"></a>',
    '</div>',
    '<a class="wp-pop-closeBtn" href="javascript:;"></a>',
    '</div>',
    '<div class="wp-pop-download">',
    '<a id="J_pop_pc" href="' + pcImg + '" target="_blank" class="wp-pop-download-box">',
    '<span class="wp-pop-icon wp-pop-download-pc"></span>',
    '<div class="txt">PC<br>( 1920 x 1080 )</div>',
    '</a>',
    '<a id="J_pop_mobile" href="' + mobileImg + '" target="_blank" class="wp-pop-download-box">',
    '<span class="wp-pop-icon wp-pop-download-mobile"></span>',
    '<div class="txt">Mobile<br>( 1080 x 1920 )</div>',
    '</a>',
    '</div>',
    '</div>'].join("");
    return html;
  ...
  setPopImg: function () {
    var self = this;
    var $tar = $("#J_wallpaper a");
    $tar.click(function (event) {
      var This = $(this);
      var popImg = This.attr("data-pop");
      var pcImg = This.attr("data-pc");
      var mobileImg = This.attr("data-mobile");
      var index = This.parent().index();
      var html = self.setPopHtml(index, popImg, pcImg, mobileImg);
      var img = new Image();
      img.src = popImg;
      img.onload = function () {
        $.cs.lightBox(html, {
        ...
        $(".wp-pop-closeBtn").click(function (event) {
          $("#boxModel,#popBox").remove();
        });
      };
    });
    $(".wp-pop-arrow-left").live("click", function () {
      var index = $(".wp-pop-wrap").data("index");
      console.log(index);
      index--;
      if (index < 0) {
        index = $tar.length - 1;
      };
      var This = $tar.eq(index);
      var popImg = This.attr("data-pop");
      var pcImg = This.attr("data-pc");
      var mobileImg = This.attr("data-mobile");
      $(".wp-pop-wrap").data("index", index);
      $("#J_pop_pc").attr("href", pcImg);
      $("#J_pop_mobile").attr("href", mobileImg);
      //loading
      var loadingHtml = "<div class='pop-loading'><img src='https://freefiremobile-a.akamaihd.net/ffwebsite/images/loading.gif'/></div>";
      $(".wp-pop-img").append(loadingHtml);
      var img = new Image();
      img.src = popImg;
      img.onload = function () {
        $("#J_pop_img").attr("src", popImg);
        $(".pop-loading").remove();
      };
    });
    $(".wp-pop-arrow-right").live("click", function () {
      var index = $(".wp-pop-wrap").data("index");
      console.log(index);
      index++;
      if (index >= $tar.length) {
